...
export const mockBillInsights: BillInsights = {
  ...
  aiExplanation: {
    summary: 'Your electricity consumption increased by 55% this month compared to last month. This is primarily due to increased heating appliance usage during winter and extended evening hours.',
    hinglishExplanation: 'Is mahine aapka bijli ka bill zyada aaya hai kyunki December mein heater aur geyser ka use badh gaya. Raat ko lights bhi zyada der tak chali. Peak hours (6-10 PM) mein usage 40% zyada tha pichle mahine se.',
    factors: [
  ...
  nextBillEstimate: {
    ...
    methodology: 'Based on your 6-month consumption pattern, seasonal trends, and current usage trajectory. January typically shows 10-15% reduction from December peak.',
    confidence: 'medium',
  },
  savingsTips: [
    {
    ...
    },
    {
      ...
      description: 'Unplug chargers, TV, and appliances when not in use. Standby mode can consume up to 10% of your bill.',
