    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          {/* Main Analytics Content - Tabs always visible */}
          <Tabs defaultValue={chartData.length === 0 ? "schemes" : "usage"} className="space-y-6">
                ...
                <Card className="text-center py-12">
                  <CardContent>
                    ...
                    <p className="text-muted-foreground max-w-md mx-auto mb-4">
                      Upload your first bill to start generating forecasts.
                    </p>
            ...
            {/* Government Schemes Tab - Always accessible */}
