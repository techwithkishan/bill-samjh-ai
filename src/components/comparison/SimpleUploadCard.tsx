/**
 * Simple Upload Card for Comparison
 * Streamlined upload without month/year selectors - auto-extracts from bill
 */
      ...
      <CardContent className="space-y-4">
        ...
        {!selectedFile && !isAnalyzed && (
          ...
          >
            <input
              type="file"
              id={`simple-file-upload-${billNumber}`}
              className="hidden"
              accept=".jpg,.jpeg,.png,.pdf"
              onChange={handleChange}
            />
            <label htmlFor={`simple-file-upload-${billNumber}`} className="cursor-pointer">
          ...
          <div className="p-3 rounded-lg bg-success/10 border border-success/30">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-foreground">
                {analyzedBill.billData.billingMonth}
              </span>
              <Button
                variant="ghost"
                size="sm"
...
export default SimpleUploadCard;
